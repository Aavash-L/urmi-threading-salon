...
const programs = [
  {
    ...
    icon: Sparkles,
    label: "Brow Loyalty",
    title: "Your 9th Brow Threading",
    reward: "is on us. Free.",
    description: "Every time you come in for eyebrow threading, you earn a stamp. Hit 9 and your next visit is completely free. No expiry, no fine print.",
    total: 9,
    freeSlot: 9,
  ...
  },
  {
    ...
    icon: Crown,
    label: "Glow Rewards",
    title: "Every 8th Brazilian Wax",
    reward: "$15 off. Just for showing up.",
    description: "Come in for a Brazilian wax and collect stamps. Every 8th visit earns you $15 off — automatically applied at checkout.",
    total: 8,
    freeSlot: 8,
