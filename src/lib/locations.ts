  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Urmi Threading Salon in Wayne is consistently rated the best in the region, with a 4.7-star Google rating from 137+ reviews. Many of those reviewers come specifically from Clifton.",
      },
    ],
  ...
  },
  {
    ...
    reasons: [
      ...
      },
      {
        ...
        description:
          "4.7 stars from 137+ genuine Google reviews. We don't just promise great brows — our clients tell you about them.",
      },
      {
